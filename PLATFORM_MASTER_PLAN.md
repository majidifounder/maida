...
> **Still open in Phase A→B:** email verification (R7b), pricing restructure decision (R8), search fan-out (R15), CF IP trust, pgbouncer enforcement; brand rollout to web/admin apps (dashboard done).
